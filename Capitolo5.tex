...
\noindent When $S$ is a closed surface, by Proposition \ref{prop:surface in ads}, the border at infinity of $\widetilde{\sigma}(\widetilde{S})$ is a proper achronal meridian $\Lambda$. So, $ \widetilde{\sigma}(\widetilde{S})$ is contained in the globally hyperbolic spacetime $\Omega(\Lambda)= \mathcal{\widetilde{\sigma}(\widetilde{S})}$, and therefore is contained in a maximal one.
