...
\end{theorem}
\begin{proof}
    Let $b$ be the unique $(1,1)$-tensor associated to $\Phi$ as in \red{Lemma da mettere}. We now want to contruct a pair $(\I,\II)$ that define a maximal immersion such that the minimal Lagrangian diffeomorphism $f_0$ associated to it, as in the proof of Theorem \ref{thm:existence}, respect $f_0^* h' = h(b \cdot, b \cdot)$. This will imply that $f_0 = \Phi$.
\end{proof}
