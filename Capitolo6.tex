...
First we need to prove some Lemma:
...
\begin{proof}
    ...
    \]
    Now, since by assumtion $\varphi$ is positive in a neighbourhood of $\partial_\infty S$, the maxumum principle implies that $\varphi$ is positive on $S$. \red{Therefore, S is included in $Conv(\partial_\infty S$)}.
\end{proof}
