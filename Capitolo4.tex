...
\begin{lemma}\label{lem:extremal extension}
    ...
    \begin{itemize}
        \item \red{capire quali dei 3 punti sono utili}
    \end{itemize}
\end{lemma}
\red{vedere i remark}
...
\red{Qui mancano ancora robe importanti}
...
\begin{figure}
    ...
    \caption{\red{mettere caption e rivedere positioning della figura}}
\end{figure}
