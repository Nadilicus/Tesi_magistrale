...
Using the half-plane model for the hyperbolic space $\H^2$, $\S$ is identified with the boundary at infinity $\partial \H^2$ and $\PSL$ corresponds to $\text{Isom}_0(\H^2)$, which acts on $\S$ in the canonical way.
